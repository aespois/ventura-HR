            ...
            <form action="criarConta" method="post">
                ...
                <div class="form-row"> 
                    <div class="form-group col-md-8">
                        ...
                        <input disabled type="text" class="form-control" id="inputRazaoSocial" name="razaoSocial" value="${usuario.razaoSocial}">
                    </div> 
                    <div class="form-group col-md-4">
                        <label for="inputCNPJ">CNPJ:</label>
                        <input disabled type="text" class="form-control" id="inputCNPJ" name="cnpj" value="${usuario.cnpj}">
                    </div>
                </div>
