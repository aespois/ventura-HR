            ...
            <form action="publicarVaga" method="post">                
                ...
                <div class="form-row"> 
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" id="inputCidade" name="cidade" value="${vaga.cidade}">
                            <option selected>Escolher...</option>
                            <option value="Rio de Janeiro" name="cidade">Rio de Janeiro - RJ</option>
                            <option value="São Paulo" name="cidade">São Paulo - SP</option>
                            <option value="Remoto" name="cidade">Remoto - Brasil</option>
                        </select>
                    </div>
                    
                    <div class="form-group col-md-2">
                        <label for="inputContrato">Contrato:</label>
                        <select class="form-control" id="inputContrato" name="cidade" value="${vaga.formaContratacao}">
                            <option selected>Escolher...</option>
                ...
                <label aria-describedby="emailHelp"><b>Critérios da Vaga</b></label><br> 
                <small id="emailHelp" class="form-text text-muted">Adicione dois critérios válidos para a Vaga:</small><br>

                <div class="form-row">                  
                    <div class="form-group col-md-8">
                        <label for="inputDescricao1">Descrição:</label>
                        <input type="text" class="form-control" id="inputDescricao1" name="descricao1" value="${criterio.descricao}">
                    </div> 

                    <div class="form-group col-md-2">
                        <label for="inputPerfil1">Perfil:</label>
                        <select class="form-control" id="inputPerfil1">
                            <option selected>Escolher...</option>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control" id="inputPeso1">
                            <option selected>Escolher...</option>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control" id="inputDescricao2" name="descricao2" value="${criterio.descricao}">
                    </div> 

                    <div class="form-group col-md-2">
                        <label for="inputPerfil2">Perfil:</label>
                        <select class="form-control" id="inputPerfil2">
                            <option selected>Escolher...</option>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control" id="inputPeso3">
                            <option selected>Escolher...</option>
